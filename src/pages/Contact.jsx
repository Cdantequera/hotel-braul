            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-zinc-900 p-6 rounded-xl border border-white/5 flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Av. del Futuro 2026, Costa Dorada, Argentina</p>
                        </div>
                    </div>
                    <div className="bg-zinc-900 p-6 rounded-xl border border-white/5 flex items-start space-x-4">
                    ...
                    <div className="bg-zinc-900 p-6 rounded-xl border border-white/5 flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">reservas@hotelbraul.com</p>
                        </div>
                    </div>
                    <div className="bg-zinc-900 p-6 rounded-xl border border-white/5 flex items-start space-x-4">
                ...
                <div className="w-full h-80 rounded-2xl overflow-hidden border border-[#C5A572]/30 shadow-2xl relative group">
                    ...
                    <iframe 
                        ...
                        width="100%" 
                        height="100%" 
                        style={{ border: 0, filter: 'grayscale(100%) invert(90%)' }} // Filtro para mapa oscuro
                        allowFullScreen="" 
                        loading="lazy"
                    ></iframe>
                </div>
