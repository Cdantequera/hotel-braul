        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-zinc-900/50 p-8 rounded-2xl border border-white/10">
            ...
            <form className="space-y-6">
              ...
              <button
                type="button"
                className="w-full py-4 bg-linear-to-r from-[#C5A572] to-[#b08d4e] text-black font-bold uppercase tracking-widest rounded-md hover:shadow-[0_0_20px_rgba(197,165,114,0.4)] transition-all flex items-center justify-center space-x-2"
              >
