                ...
                {bookings.map((b) => (
                  <tr key={b._id} className="hover:bg-zinc-900/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-400">
                      Hab. {b.room?.number || "?"}
                      <br />
                      <span className="text-xs text-gray-600">{b.room?.type}</span>
                    </td>
                    <td className="px-6 py-4 text-xs text-gray-400">
                      In: {new Date(b.checkIn).toLocaleDateString()}
                      <br />
                    ...
                    <td className="px-6 py-4 text-sm font-bold text-white">
                      ...
                      <br />
                      <span
                        className={`text-[10px] uppercase ${b.paymentStatus === "paid" ? "text-green-500" : "text-yellow-500"}`}
                      >
                        {b.paymentStatus}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-center space-x-2">
                      <button
                        className="p-2 bg-zinc-800 text-gray-300 hover:text-[#C5A572] rounded transition-colors"
                        title="Ver detalles"
                      >
                        <Eye className="h-4 w-4" />
                      </button>
                      <button
                        className="p-2 bg-zinc-800 text-gray-300 hover:text-red-500 rounded transition-colors"
