      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-3xl font-bold text-white">
            ${room.price} <span className="text-sm font-normal text-gray-400">/ noche</span>
          </p>
        </div>
...
const BookingWidget = () => {
  ...
  const inputStyles =
    "w-full bg-transparent border-b border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:border-[#C5A572] py-2 transition-colors text-sm sm:text-base relative z-50";
  ...
  return (
    <div className="bg-black/60 backdrop-blur-xl p-6 md:p-8 rounded-2xl border border-white/10 shadow-2xl max-w-4xl mx-auto mt-10 transform hover:scale-[1.01] transition-all duration-500 relative z-20">
      <form onSubmit={handleSearch} className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
        ...
        <button
          type="submit"
          className="w-full h-12 bg-linear-to-r from-[#C5A572] to-[#b08d4e] hover:from-[#b08d4e] hover:to-[#C5A572] text-black font-bold uppercase tracking-widest rounded-md shadow-lg transition-all flex items-center justify-center space-x-2 relative z-50 cursor-pointer"
        >
    ...
    <div className="bg-black min-h-screen">
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center pt-20">
          <h5 className="text-[#C5A572] text-sm md:text-base font-bold uppercase tracking-[0.3em] mb-4 drop-shadow-lg">
            Welcome to the future
          </h5>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold text-white mb-6 leading-tight drop-shadow-2xl">
            HOTEL{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-[#C5A572] to-[#E0C185]">
              BRA'UL
            </span>
          </h1>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden bg-black">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif font-bold text-white mb-4 uppercase tracking-wide">
              Experiencias <span className="text-[#C5A572]">Únicas</span>
            </h2>
            <p className="text-gray-400 max-w-xl mx-auto">
              Redefinimos el lujo con servicios exclusivos.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <Link
                to="/services"
                key={idx}
                className="group p-6 rounded-xl border border-white/10 bg-white/5 hover:border-[#C5A572]/50 hover:bg-white/10 transition-all duration-300 text-center cursor-pointer"
              >
      ...
      <section className="relative py-20 md:py-32 bg-zinc-900/30">
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div>
              <h5 className="text-[#C5A572] font-bold uppercase tracking-[0.2em] mb-2 text-xs md:text-sm">
                Tu espacio privado
              </h5>
              <h2 className="text-3xl md:text-5xl font-serif font-bold text-white uppercase">
                Nuestras <span className="text-[#C5A572]">Suites</span>
              </h2>
            </div>
            <Link
              to="/rooms"
              className="hidden md:flex items-center text-[#C5A572] font-bold uppercase tracking-widest hover:text-white transition-colors mt-4 md:mt-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredRooms.length > 0 ? (
              featuredRooms.map((room) => (
                <RoomCard key={room._id} room={room} onReserve={handleReserveClick} />
              ))
            ) : (
          ...
          <div className="md:hidden mt-8 text-center">
            <Link
              to="/rooms"
              className="inline-flex items-center text-[#C5A572] font-bold uppercase tracking-widest hover:text-white transition-colors"
            >
              Ver Todas <ArrowRight className="ml-2 h-5 w-5" />
            </Link>
          </div>
      ...
      <section className="relative py-24 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <Link
            to="/contact"
            className="inline-block px-10 py-4 bg-transparent border-2 border-[#C5A572] text-[#C5A572] font-bold uppercase tracking-[0.2em] hover:bg-[#C5A572] hover:text-black transition-all duration-300 transform hover:scale-105"
          >
            Comienza tu viaje
          </Link>
        </div>
