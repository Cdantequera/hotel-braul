      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-black p-8 rounded-xl shadow-[0_0_40px_rgba(197,165,114,0.15)] border border-gray-100 dark:border-[#C5A572]/30">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Ingresa tu email y te enviaremos un enlace para volver a entrar a{" "}
            <span className="text-[#C5A572] font-bold">Bra'ul</span>.
          </p>
        </div>
        ...
        <div className="text-center mt-4">
          <Link
            to="/login"
            className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-[#C5A572] dark:text-gray-400 transition-colors"
          >
