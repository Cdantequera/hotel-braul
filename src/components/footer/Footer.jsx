      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Donde el lujo futurista se encuentra con la serenidad absoluta. Una experiencia
              inolvidable en cada estancia.
            </p>
          </div>

          {/* COLUMNA 2: ENLACES RÁPIDOS */}
          <div>
            <h4 className="text-[#C5A572] font-bold uppercase tracking-widest text-xs mb-6">
              Explorar
            </h4>
        ...
        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-xs text-gray-600 hover:text-[#C5A572] transition-colors">
